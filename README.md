...
- 🔹 **Outlier Removal**  
  Removed illogical entries such as applicants with age greater than 100 years to maintain data integrity.

- 🔹 **Data Validation**  
  Checked distributions and ensured all values fall within realistic financial ranges.

- 🔹 **Missing Values Handling**  
  Cleaned or removed missing entries to prevent bias during model training.
...
- 🔹 **Ordinal Encoding**  
  Applied to ordered features such as education levels to reflect hierarchy  
  *(High School < Bachelor < Master < Doctorate)*

- 🔹 **One-Hot Encoding**  
  Used for nominal features like loan purpose and home ownership to avoid introducing false relationships.

- 🔹 **Binary Encoding**  
  Converted yes/no features (e.g., previous defaults) into **0/1 format** for model compatibility.
...
This project demonstrates how machine learning can be applied to **credit risk analysis**, helping financial institutions make **data-driven decisions** and reduce potential losses.
